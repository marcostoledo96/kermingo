...
INSERT IGNORE INTO configuracion_tienda (id, estado) VALUES (1, 'cerrada');

-- Productos — Cena · Comidas
INSERT IGNORE INTO producto (id, nombre, descripcion, precio, tipo, stock_limitado, stock_actual, stock_minimo_alerta, activo) VALUES
...
(8,  'Chocotorta',         'Porción clásica de chocolinas y dulce de leche.',                 2500, 'comida', 1, 20, 3, 1),
(9,  'Torta frita',        'Recién hechas, ideales con mate.',                                1000, 'comida', 1, 30, 5, 1),
(10, 'Medialunas',         'Par de medialunas de manteca.',                                   1600, 'comida', 1, 25, 3, 1),
(11, 'Medialunas J&Q',     'Rellenas con jamón y queso, calentitas.',                         2200, 'comida', 1, 15, 3, 1),
(12, 'Churros',            'Rellenos de dulce de leche.',                                     1500, 'comida', 1, 20, 3, 1),
...
(16, 'Gaseosa naranja',    'Lata 354 ml.',                                                    1900, 'bebida', 1, 30, 5, 1),
(17, 'Lima limón',         'Lata 354 ml.',                                                    1900, 'bebida', 1, 20, 5, 1),
(18, 'Agua mineral',       'Botella 500 ml, con o sin gas.',                                  1500, 'bebida', 0, NULL, 0, 1),
(19, 'Mate cocido',        'Calentito, servido en vaso.',                                     1200, 'bebida', 0, NULL, 0, 1),
(20, 'Té',                 'Variedad de saquitos.',                                           1000, 'bebida', 0, NULL, 0, 1),
