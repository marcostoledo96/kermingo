...
| **comprobante** | Archivo adjunto que prueba el pago por transferencia. Funcionalidad pendiente (B6.3). La tabla `archivo_drive` existe pero no se usa todavía. |
...
| **metodo_pago** | ENUM de MySQL: `'transferencia'` o `'efectivo'`. Online solo permite efectivo (B6.3). Caja permite ambos. |
